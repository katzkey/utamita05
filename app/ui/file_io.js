...
import { getProject, getUi, replaceProject, setUi, markSaved, setProject, registerFileBlob, restoreProjectFiles, getFileBlobUrl } from "./state.js?v=058eb8e";
import { fromJSON, toJSON } from "../core/project.js?v=058eb8e";
import { getTemplatesRegistry } from "../core/templates_loader.js?v=058eb8e";
