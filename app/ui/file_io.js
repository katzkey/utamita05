...
import { getProject, getUi, replaceProject, setUi, markSaved, setProject, registerFileBlob, restoreProjectFiles, getFileBlobUrl } from "./state.js?v=c86b3e0";
import { fromJSON, toJSON } from "../core/project.js?v=c86b3e0";
import { getTemplatesRegistry } from "../core/templates_loader.js?v=c86b3e0";
