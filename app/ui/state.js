...
import { createEmptyProject } from "../core/project.js?v=6c5382d";
import { saveFileToStore, loadFileFromStore } from "../core/file_store.js?v=6c5382d";
import { putBlob, getBlobUrl, getBlobFile, hasBlob, clearBlobs } from "../core/blob_registry.js?v=6c5382d";
