...
import { getBlobUrl as getFileBlobUrl } from "./blob_registry.js?v=8bd5bff";
import { cssFamilyFor, labelFor } from "./fonts_loader.js?v=8bd5bff";
import { parseJitterBlocks, jitterOffsetFor } from "./utils.js?v=8bd5bff";
import { SMALL_KANA, classifyChar, autoKerningEm } from "./char_type.js?v=8bd5bff";
import { escapeHtml } from "./html.js?v=8bd5bff";
