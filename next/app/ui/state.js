...
import { createEmptyProject } from "../core/project.js?v=8ceb86c";
import { saveFileToStore, loadFileFromStore } from "../core/file_store.js?v=8ceb86c";
import { putBlob, getBlobUrl, getBlobFile, hasBlob, clearBlobs } from "../core/blob_registry.js?v=8ceb86c";
