...
import { createEmptyProject } from "../core/project.js?v=663afdc";
import { saveFileToStore, loadFileFromStore } from "../core/file_store.js?v=663afdc";
import { putBlob, getBlobUrl, getBlobFile, hasBlob, clearBlobs } from "../core/blob_registry.js?v=663afdc";
