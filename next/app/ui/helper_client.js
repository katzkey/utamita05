...
export function helperMissingHtml(extra = "") {
  ...
  const macHtml = `
    ...
    <div style="margin:8px 0 6px">
      <code id="hxCmd" style="display:block;padding:8px;background:var(--gray-1);border-radius:4px;
        font-size:11px;word-break:break-all;user-select:all">curl -fsSL https://katzkey.github.io/utamita05/next/tools/setup_helper.sh | bash</code>
  ...
  if (isSafari()) {
    return `<div class="at-warn">
      ...
      <code style="user-select:all">https://katzkey.github.io/utamita05/next/app/</code><br>
      <br>
