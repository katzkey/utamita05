...
import { getProject, getUi, getFileBlob } from "./state.js?v=6c5382d";
import { renderLinePreviewHtml } from "../core/render_line.js?v=6c5382d";
import { renderLineLayer } from "../core/render_layer.js?v=6c5382d";
import { escapeHtml } from "../core/html.js?v=6c5382d";
import { pingHelper, startJob, downloadUrl,
         helperStatusHtml, helperMissingHtml, bindHelperMissing, stepsHtml, fmtSec } from "./helper_client.js?v=6c5382d";

import * as jobs from "./job_status.js?v=6c5382d";
...
function renderError(msg) {
  const el = body(); if (!el) return;
  el.innerHTML = `<div class="at-warn" style="white-space:pre-wrap;font-family:inherit;max-height:40vh;overflow:auto">${escapeHtml(msg)}</div>
