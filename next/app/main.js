...
import { subscribe, getProject, getUi, setUi, replaceProject, undo, redo, canUndo, canRedo } from "./ui/state.js?v=663afdc";
import { loadTemplatesRegistry, getTemplatesRegistry } from "./core/templates_loader.js?v=663afdc";
import { initCustomPresets } from "./core/custom_presets.js?v=663afdc";
import { applyFeatureFlags } from "./core/features.js?v=663afdc";
import * as lyrics from "./ui/lyrics_tab.js?v=663afdc";
import * as bgTab from "./ui/background_tab.js?v=663afdc";
import * as titlesTab from "./ui/titles_tab.js?v=663afdc";
import * as tmplTab from "./ui/templates_tab.js?v=663afdc";
import * as settings from "./ui/settings_tab.js?v=663afdc";
import * as playbar from "./ui/playbar.js?v=663afdc";
import * as fileio from "./ui/file_io.js?v=663afdc";
import * as autoTiming from "./ui/auto_timing.js?v=663afdc";
import * as videoExport from "./ui/video_export.js?v=663afdc";
import * as jobs from "./ui/job_status.js?v=663afdc";
import { probeFonts, loadLocalFonts, autoAliasMissing, hasLocalFontAccess, isFontValueAvailable } from "./core/fonts_loader.js?v=663afdc";
import { FONT_PRESETS } from "./core/presets.js?v=663afdc";
