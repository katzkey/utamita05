...
import { subscribe, getProject, getUi, setUi, replaceProject, undo, redo, canUndo, canRedo } from "./ui/state.js?v=a2aac36";
import { loadTemplatesRegistry, getTemplatesRegistry } from "./core/templates_loader.js?v=a2aac36";
import { initCustomPresets } from "./core/custom_presets.js?v=a2aac36";
import { applyFeatureFlags } from "./core/features.js?v=a2aac36";
import * as lyrics from "./ui/lyrics_tab.js?v=a2aac36";
import * as bgTab from "./ui/background_tab.js?v=a2aac36";
import * as titlesTab from "./ui/titles_tab.js?v=a2aac36";
import * as tmplTab from "./ui/templates_tab.js?v=a2aac36";
import * as settings from "./ui/settings_tab.js?v=a2aac36";
import * as playbar from "./ui/playbar.js?v=a2aac36";
import * as fileio from "./ui/file_io.js?v=a2aac36";
import * as autoTiming from "./ui/auto_timing.js?v=a2aac36";
import * as videoExport from "./ui/video_export.js?v=a2aac36";
import * as jobs from "./ui/job_status.js?v=a2aac36";
