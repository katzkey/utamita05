...
import { getBlobUrl as getFileBlobUrl } from "./blob_registry.js?v=8ceb86c";
import { cssFamilyFor, fontStackFor, labelFor } from "./fonts_loader.js?v=8ceb86c";
import { parseJitterBlocks, jitterOffsetFor } from "./utils.js?v=8ceb86c";
import { SMALL_KANA, classifyChar, autoKerningEm, typeKerningEm } from "./char_type.js?v=8ceb86c";
import { escapeHtml } from "./html.js?v=8ceb86c";
