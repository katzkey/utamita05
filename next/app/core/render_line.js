...
import { getBlobUrl as getFileBlobUrl } from "./blob_registry.js?v=4763f1e";
import { cssFamilyFor, fontStackFor, labelFor } from "./fonts_loader.js?v=4763f1e";
import { parseJitterBlocks, jitterOffsetFor } from "./utils.js?v=4763f1e";
import { SMALL_KANA, classifyChar, autoKerningEm, typeKerningEm } from "./char_type.js?v=4763f1e";
import { escapeHtml } from "./html.js?v=4763f1e";
